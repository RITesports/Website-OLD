...
const Founders: React.FC = () => {
  ...
  return (
    <Container maxWidth="xl">
      ...
      <Typography variant="h5" align="center" className={classes.messages}>RIT Esports was founded by Evan Hirsh, Peter Lam, Andy Kukielka, Joseph Farrell, Winnie Chen, and Chad Weeden along with the support of:</Typography>
      <Grid container>
        {names.map((name) => (
